...
public class pre_index {
    ...
    private void seleccionarSucursal(String ide_sucu) {
        ...
        ale_inicio.setAlertaCeleste("<strong>Bienvenido </strong> al Sistema de Reportes de Banco Solidario <span class='pull-right'> " + utilitario.getFechaLarga(utilitario.getFechaActual()) + " &nbsp;  </span>");
