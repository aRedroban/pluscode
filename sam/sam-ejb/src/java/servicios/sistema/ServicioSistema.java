...
public class ServicioSistema {
    ...
    public TablaGenerica getOpcionPantalla() {
        return utilitario.consultar("SELECT PAQUETE_OPCI,TIPO_OPCI,AUDITORIA_OPCI,MANUAL_OPCI FROM SIS_OPCION WHERE IDE_OPCI = "+ utilitario.getVariable("IDE_OPCI")  ); //+ utilitario.getVariable("IDE_OPCI")
    }
